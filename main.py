...
def parse_args():
    ...
    parser.add_argument('--n', type=int, default=50000, help='The number of dataset')
    parser.add_argument('--dataset', type=str, default='cifar100', choices=['mnist', 'fashion-mnist', 'celebA', 'cifar10'],
    ...
    parser.add_argument('--unlabel_batch_size', type=int, default=100, help='The size of unlabel batch')
